...
🔗 **Live:** [ml-togo.netlify.app](https://ml-togo.netlify.app/)

## Available Tools

| Tool | Description |
|------|-------------|
| [Data Preparation & Feature Engineering](https://ml-togo.netlify.app/DataPreparationAndFeatureEngineering/) | Interactive pipeline covering EDA, data types, imputation, scaling, encoding, and feature selection with the Heart Failure dataset |
